  ...
  <div class="profile" v-if="user.isLogin">
    ...
    <div class="card">
      <div style="display:flex;justify-content:space-between;align-items:center;">
        ...
        <router-link to="/admin" style="font-size:13px;color:#d4a843;">⚙️ 管理后台</router-link>
      </div>
...
.avatar-big { width: 72px; height: 72px; border-radius: 50%; background: #fef9ed; display: flex; align-items: center; justify-content: center; font-size: 36px; }
.nickname { font-size: 20px; font-weight: 700; }
.uid { font-size: 13px; color: #bbb; margin-top: 4px; }
.history-item { padding: 14px 0; border-bottom: 1px solid #f5f5f5; cursor: pointer; }
.history-item:hover { color: #d4a843; }
.h-query { font-size: 14px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.h-time { font-size: 12px; color: #bbb; margin-top: 4px; }
</style>
